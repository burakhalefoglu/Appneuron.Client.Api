...
public class ClientMapper: Mappings
{
    public ClientMapper()
    {
        ...
        For<ClientDataModel>()
            ...
            .Column(u => u.PaidTime, cm => cm.WithName("paid_time").WithDbType(typeof(DateTimeOffset)))
            .Column(u => u.IsPaidClient, cm => cm.WithName("is_paid_client").WithDbType(typeof(bool)))
