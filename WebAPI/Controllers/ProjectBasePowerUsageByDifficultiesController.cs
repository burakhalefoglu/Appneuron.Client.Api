...
namespace WebAPI.Controllers
{
    ...
    [ApiController]
    public class ProjectBasePowerUsageByDifficultiesController : BaseApiController
    {
        ///<summary>
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(IEnumerable<ProjectBasePowerUsageByDifficulty>))]
        ...
        ///<response code="200"></response>  
        [Produces("application/json", "text/plain")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ProjectBasePowerUsageByDifficulty))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        [HttpGet("getbyid")]
