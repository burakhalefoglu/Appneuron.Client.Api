...
namespace WebAPI.Controllers
{
    ...
    [ApiController]
    public class MlResultModelsController : BaseApiController
    {
        ///<summary>
        ///List MlResultModels
        ///</summary>
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(IEnumerable<MlResultModel>))]
        ...
        ///<response code="200"></response>  
        [Produces("application/json", "text/plain")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(MlResultModel))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        [HttpGet("getbyid")]
        ...
        ///<response code="200"></response>  
        [Produces("application/json", "text/plain")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(MlResultDto))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        [HttpGet("getbyproductId")]
        public async Task<IActionResult> GetByProductId(short productId)
        {
            var result = await Mediator.Send(new GetMlResultDtoQuery { ProductId = productId });
            if (result.Success)
            {
                return Ok(result.Data);
            }
