...
namespace WebAPI.Controllers
{
    ...
    [ApiController]
    public class PlayerListByDaysController : BaseApiController
    {
        ///<summary>
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(IEnumerable<ProjectBasePlayerListByDayWithDifficulty>))]
        ...
        ///<response code="200"></response>  
        [Produces("application/json", "text/plain")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ProjectBasePlayerListByDayWithDifficulty))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        [HttpGet("getbyid")]
