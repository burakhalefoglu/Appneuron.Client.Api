...
namespace WebAPI.Controllers
{
    ...
    public class ProjectBaseBuyingCountWithDifficultiesController : BaseApiController
    {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(IEnumerable<ProjectBaseBuyingCountWithDifficulty>))]
        ...
        ///<response code="200"></response>  
        [Produces("application/json", "text/plain")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ProjectBaseBuyingCountWithDifficulty))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(string))]
        [HttpGet("getbyid")]
