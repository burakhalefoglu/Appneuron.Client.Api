...
namespace Business.Handlers.LevelBaseSessionDatas.Commands
{
    ...
    public class DeleteLevelBaseSessionDataByProjectIdCommand : IRequest<IResult>
    {
        ...
        public class
            DeleteLevelBaseSessionDataByProjectIdCommandHandler : IRequestHandler<
                DeleteLevelBaseSessionDataByProjectIdCommand, IResult>
        {
            private readonly ILevelBaseSessionDataRepository _levelBaseSessionDataRepository;
            private readonly IMediator _mediator;

            public DeleteLevelBaseSessionDataByProjectIdCommandHandler(
            ...
            public async Task<IResult> Handle(DeleteLevelBaseSessionDataByProjectIdCommand request,
