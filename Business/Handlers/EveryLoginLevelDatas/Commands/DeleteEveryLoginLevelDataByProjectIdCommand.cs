...
namespace Business.Handlers.EveryLoginLevelDatas.Commands
{
    ...
    public class DeleteEveryLoginLevelDataByProjectIdCommand : IRequest<IResult>
    {
        ...
        public class
            DeleteEveryLoginLevelDataByProjectIdCommandHandler : IRequestHandler<
                DeleteEveryLoginLevelDataByProjectIdCommand, IResult>
        {
            private readonly IEveryLoginLevelDataRepository _everyLoginLevelDataRepository;
            private readonly IMediator _mediator;

            public DeleteEveryLoginLevelDataByProjectIdCommandHandler(
            ...
            public async Task<IResult> Handle(DeleteEveryLoginLevelDataByProjectIdCommand request,
